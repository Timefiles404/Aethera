...
function getRightIndex(index) {
    ...
    // 只处理配料槽位 1-8
    const ingredientSlots = [1, 2, 3, 4, 5, 6, 7, 8];
    if (!ingredientSlots.includes(index)) return -1;
    
    // 根据实际布局计算右边的槽位
     switch(index) {
         case 1: return 2;  // 1的右边是2
         case 2: return 3;  // 2的右边是3
         case 3: return -1; // 3的右边是空槽
         case 4: return 5;  // 4的右边是5（隔着基础材料槽）
         case 5: return -1; // 5的右边是工艺按钮
         case 6: return 7;  // 6的右边是7
         case 7: return 8;  // 7的右边是8
         case 8: return -1; // 8的右边是结果槽
         default: return -1;
     }
}
...
function getDownIndex(index) {
    ...
    switch(index) {
        case 1: return 4;  // 1的下边是4
        case 2: return 7;  // 2的下边是7（隔着基础材料槽）
        case 3: return 5;  // 3的下边是5
        case 4: return 6;  // 4的下边是6
        case 5: return 8;  // 5的下边是8
        case 6: return -1; // 6的下边是空槽
        case 7: return -1; // 7的下边是空槽
        case 8: return -1; // 8的下边是空槽
        default: return -1;
    }
}
...
function getLeftIndex(index) {
    ...
    switch(index) {
         case 1: return -1; // 1的左边是边界
         case 2: return 1;  // 2的左边是1
         case 3: return 2;  // 3的左边是2
         case 4: return -1; // 4的左边是边界
         case 5: return 4;  // 5的左边是4（隔着基础材料槽）
         case 6: return -1; // 6的左边是边界
         case 7: return 6;  // 7的左边是6
         case 8: return 7;  // 8的左边是7
         default: return -1;
     }
}
...
function getUpIndex(index) {
    ...
    switch(index) {
        case 1: return -1; // 1的上边是边界
        case 2: return -1; // 2的上边是边界
        case 3: return -1; // 3的上边是边界
        case 4: return 1;  // 4的上边是1
        case 5: return 3;  // 5的上边是3
        case 6: return 4;  // 6的上边是4
        case 7: return 2;  // 7的上边是2（隔着基础材料槽）
        case 8: return 5;  // 8的上边是5
        default: return -1;
    }
}
